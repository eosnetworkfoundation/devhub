...
<!--                <NuxtLink class="link" to="/win">Win!</NuxtLink>-->
...
<!--                    <NuxtLink @click.native="hamburgerOpen = false" class="link" to="/win">Win!</NuxtLink>-->
                    <!--        <NuxtLink @click.native="hamburgerOpen = false" class="link" to="/discover?type=tools">Discover</NuxtLink>-->
                    <a href="https://docs.eosnetwork.com"  target="_blank" rel="noopener noreferrer" @click="hamburgerOpen = false" class="link">Docs</a>
                </section>
            </section>
        </nav>
...
export default {
    ...
    computed:{
        ...
        authStateNonce(){ return this.$store.state.authStateNonce },
    },
    watch: {
        authStateNonce(){
